    ...
    while True:
        ...
        for idx in range(args.batch_size):
            ...
            if random_context:
                ...
                src_context = [(torch.randint_like(a,len(src_dict))) for a in src_context]
                tgt_context = [(torch.randint_like(a,len(tgt_dict))) for a in tgt_context]
                #print("random")
                #print(src_context) 
            else:
                src_context = src_context_lines[idx]
        ...
        # decode hypothesis
            ...
            #print("output: ", decode(hyp_ids, tgt_spm, tgt_dict), flush=True)
