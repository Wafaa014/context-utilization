...
class MultilingualDatasetManager(object):
    ...
    def load_langs(cls, args, **kwargs):
        args.lang_dict= '/ivi/ilps/personal/wmohamm/models/mbart50.ft.n1/ML50_langs.txt'
        args.langs=None
        #print(args.langs)
    ...
    def prepare(cls, load_dictionary, args, **kargs):
        # this is for the pretrained (MT) mbart model
        args.source_lang= "en_XX"
        args.target_lang= "de_DE"
    ...
    def load_all_dictionaries(cls, args, language_list, load_dictionary, training):
        # this is for the pretrained (MT) mbart version
        args.source_dict = "/ivi/ilps/personal/wmohamm/wmt2022/data/extracted/agent/bin/dict.en_XX.txt"
        args.target_dict = "/ivi/ilps/personal/wmohamm/wmt2022/data/extracted/agent/bin/dict.de_DE.txt"
        #print(args.source_dict)
        #print(args.target_dict)
        dicts = OrderedDict()
